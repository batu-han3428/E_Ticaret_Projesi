...
{
    public class Iphone12ProMax_IPhone_IOS_Telefonlar: IIphone12ProMax_IPhone_IOS_Telefonlar, ITelefonOzellikleri
    {
        public int Iphone12ProMaxIPhoneIOSTelefonlarId { get; set; }
